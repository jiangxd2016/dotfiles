    ...
    "honza/vim-snippets", "github/copilot.vim", {
        ...
        init = function()
            vim.g.coc_global_extensions = {
                "coc-word", "coc-dictionary", "coc-emoji", "coc-yaml",
                "coc-toml", "@yaegassy/coc-tailwindcss3", "coc-css",
                ...
                "coc-rust-analyzer", "coc-tsserver", "coc-tag",
                "coc-sumneko-lua", "coc-clangd", "coc-snippets",
                "coc-spell-checker", "coc-sumneko-lua"
            }
        end,
        config = function()
